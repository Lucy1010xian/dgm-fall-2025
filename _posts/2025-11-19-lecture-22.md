...
abstract: >
  This lecture introduces the principles of unsupervised training for large language models (LLMs), including tokenization, optimization
  objectives, self-supervised signals, and strategies for efficient large-scale training.
---

## Today’s topics：
- **1. Recall GPT training objective**
- **2. Scale & Emergent Capabilities**
